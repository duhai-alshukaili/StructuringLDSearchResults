...
def ontWeightMap = PSLUtil.initializeWeightMap(1.0, 23, "o");
...
*/
	...
	// Entity
	model.add rule: (RDFSubject(S) & RDFIsInstanceOf(S,T)) >> Entity(S), weight: w["w1"], squared: sq;
	...
	// property
	model.add rule: (RDFSubjPredicate(S,P) & RDFIsInstanceOf(S,T)) >> Property(P), weight: w["w2"], squared: sq;
	model.add rule: (RDFPredicate(P) & fnMetaVocab(P)) >> ~Property(P), constraint: true;

	// EntityType
	model.add rule: (RDFIsInstanceOf(S,T) & ~RDFType(S) & ~RDFPredicate(S) & ~IsDictWord(T)) >> ~EntityType(T), weight: w["w3"], squared: sq;
	model.add rule: (RDFIsInstanceOf(S,T) & ~RDFType(S) & ~RDFPredicate(S) & IsDictWord(T)) >> EntityType(T), weight: w["w4"], squared: sq;
	model.add rule: (RDFIsInstanceOf(S,T) & ~RDFType(S) & ~RDFPredicate(S)) >> EntityType(T), weight: w["w5"], squared: sq;
	...
	// HasDomain
	model.add rule: (Triple1(S,P,O) & ~RDFType(S) & ~RDFPredicate(S) & ~fnMetaVocab(P) & RDFIsInstanceOf(S,T)) >> HasDomain(O,P), weight: w["w14"], squared: sq;
	model.add rule: (Triple2(S,P,O) & ~RDFType(S) & ~RDFPredicate(S) & ~fnMetaVocab(P) & RDFIsInstanceOf(S,T)) >> HasDomain(O,P), weight: w["w15"], squared: sq;

	// HasType
	//model.add rule: (RDFIsInstanceOf(S,T) & ~RDFType(S) & ~RDFPredicate(S) & ~fnMetaVocab(T) & ~fnYagoType(T)) >> HasType(S,T), weight: w["w14"];
	model.add rule: (EntityType(T) & Entity(S)  & RDFIsInstanceOf(S,T)) >> HasType(S,T), weight: w["w16"], squared: sq;
	...
	*/
	...
	// ontology rules
	// Entity
	model.add rule: (RDFSubject(S) & RDFIsInstanceOf(S,OT)  & OntType(OT)) >> Entity(S), weight: ow["o1"], squared: sq;
	model.add rule: (RDFSubject(S) & RDFIsInstanceOf(S,T)  & OntType(OT) & fnLexURISim(T,OT)) >> Entity(S), weight: ow["o2"], squared: sq;
	model.add rule: (RDFSubject(S) & RDFIsInstanceOf(S,T)  & OntEqTypes(T,OT)) >> Entity(S), weight: ow["o3"], squared: sq;
	
	
	// Property
	model.add rule: (Entity(S) & RDFSubjPredicate(S,OP) & OntProperty(OP)) >> Property(OP), weight: ow["o4"], squared: sq;
	model.add rule: (Entity(S) & RDFSubjPredicate(S,P) & OntProperty(OP) & fnLexURISim(P,OP)) >> Property(P), weight: ow["o5"], squared: sq;
	model.add rule: (Entity(S) & RDFSubjPredicate(S,P) & OntEqProps(P,OP)) >> Property(P), weight: ow["o6"], squared: sq;
	
	// EntityType
	model.add rule: (RDFIsInstanceOf(S,OT) & OntType(OT)) >> EntityType(OT), weight: ow["o7"], squared: sq;
	//model.add rule: (RDFIsInstanceOf(S,OT) & OntType(OT)) >> ~EntityType(OT), weight: ow["o7"];
	model.add rule: (RDFIsInstanceOf(S,T) & OntType(OT) & fnLexURISim(T,OT)) >> EntityType(T), weight: ow["o8"], squared: sq;
	model.add rule: (RDFIsInstanceOf(S,T) & OntEqTypes(T,OT) ) >> EntityType(T), weight: ow["o9"], squared: sq;
...
def level2(DataStore data, def w, def p, def ow, def fp, String callSource, boolean sq) {
	...
	// ontology rules
	model.add rule: (Property(P1) & Property(P2) & OntEqProps(P1,P2)) >>  SimProperty(P1,P2), weight: ow["o13"], squared: sq;
	model.add rule: (Property(P1) & Property(P2) & OntEqProps(OP1,OP2) & OntSimURI(P1,OP1) & OntSimURI(P2,OP2)) >> SimProperty(P1,P2), weight: ow["o14"], squared: sq;
	model.add rule: (Property(P1) & Property(P2) & OntProperty(OP) & OntSimURI(P1,OP) & OntSimURI(P2,OP)) >> SimProperty(P1,P2), weight: ow["o15"], squared: sq;
...
def level3(DataStore data, def w, def p, def ow, def fp, String callSource, boolean sq) {
	...
	// ontology rules
	model.add rule: (EntityType(T1) & EntityType(T2) & OntEqTypes(T1,T2)) >> SimEntityType(T1,T2), weight: ow["o16"], squared: sq;
	model.add rule: (EntityType(T1) & EntityType(T2) & OntType(OT) & OntSimURI(T1,OT) & OntSimURI(T2,OT)) >> SimEntityType(T1,T2), weight: ow["o17"], squared: sq;
	model.add rule: (EntityType(T1) & EntityType(T2) & OntEqTypes(OT1,OT2) & OntSimURI(T1,OT1) & OntSimURI(T2,OT2)) >> SimEntityType(T1,T2), weight: ow["o18"], squared: sq;
	model.add rule: (EntityType(T1) & EntityType(T2) & OntDisjointTypes(T1,T2)) >> ~SimEntityType(T1,T2), weight: ow["o19"], squared: sq;
	model.add rule: (EntityType(T1) & EntityType(T2) & OntDisjointTypes(OT1,OT2) & OntSimURI(T1,OT1) & OntSimURI(T2,OT2)) >> ~SimEntityType(T1,T2), weight: ow["o20"], squared: sq;
...
def level4(DataStore data, def w, def p, def ow, def fp, String callSource, boolean sq) {
	...
	model.add rule: (Entity(E1) & Entity(E2) & Label(E1, L1) & Label(E2, L2) & SimilarLabels(L1,L2)) >> SimEntity(E1,E2), weight: w["w24"], squared: sq;

	model.add rule: (Entity(E1) & Entity(E2) & Label(E1, L1) & Label(E2, L2) & ~SimilarLabels(L1,L2)) >> ~SimEntity(E1,E2), weight: w["w25"], squared: sq;

	model.add rule: (Entity(E1) & Entity(E2) & Name(E1, N1) & Name(E2, N2) & SimilarNames(N1,N2)) >> SimEntity(E1,E2), weight: w["w26"], squared: sq;

	model.add rule: (Entity(E1) & Entity(E2) & Name(E1, N1) & Name(E2, N2) & ~SimilarNames(N1,N2)) >> ~SimEntity(E1,E2), weight: w["w27"], squared: sq;

	model.add rule: (Entity(E1) & Entity(E2) & Triple1(E1, P1, O1) & Triple1(E2, P2, O2) & Property(P1) & Property(P2) & SimProperty(P1,P2) & fnLexURISim(O1,O2)) >> SimEntity(E1,E2), weight: w["w28"], squared: sq;

	model.add rule: (Entity(E1) & Entity(E2) & Triple2(E1, P1, O1) & Triple2(E2, P2, O2) & Property(P1) & Property(P2) & SimProperty(P1,P2) & SimilarLiterals(O1,O2)) >> SimEntity(E1,E2), weight: w["w29"], squared: sq;
	...
	// ontology rules
	model.add rule: (Entity(E1) & Entity(E2) & HasType(E1,T1) & HasType(E2,T2) & OntEqTypes(T1,T2) & SimValueSet ({E1.HasPropertyValue} , {E2.HasPropertyValue})) >> SimEntity(E1,E2), weight: ow["o21"];
	model.add rule: (Entity(E1) & Entity(E2) & HasType(E1,T1) & HasType(E2,T2) & OntDisjointTypes(T1,T2)) >> ~SimEntity(E1,E2), weight: ow["o22"];
	model.add rule: (Entity(E1) & Entity(E2) & HasType(E1,T1) & HasType(E2,T2) & OntDisjointTypes(OT1,OT2) & OntSimURI(T1,OT1) & OntSimURI(T2,OT2)) >> ~SimEntity(E1,E2), weight: ow["o23"];
