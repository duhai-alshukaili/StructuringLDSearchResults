...
public class LexicalLongStringSimilarity implements ExternalFunction {
	...
	public LexicalLongStringSimilarity() {
	...
	public double getValue(ReadOnlyDatabase db, GroundTerm... args) {
		...
		*/
		...
		//return (new CosineSimilarity()).getSimilarity(bean0.getLiteralString(), 
	    //                                bean1.getLiteralString());
	    
		return (new CosineSimilarity()).getSimilarity(arg0,arg1);
	}
